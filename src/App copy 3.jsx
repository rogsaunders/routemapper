    ...
    <div className="p-4">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="bg-black text-green-400 font-mono text-4xl px-6 py-3 rounded-xl shadow-2xl border-2 border-green-600 tracking-widest">
            🛣️ {totalDistance.toFixed(2)} km
          </div>
        </div>
