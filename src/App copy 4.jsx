    ...
    <div className="p-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <h2 className="text-lg font-semibold">📍 Waypoint Entry</h2>
          ...
          <div className="flex justify-center items-center gap-8 mx-auto">
            ...
            <button
              ...
              disabled={!currentGPS}
              className="flex flex-col items-center justify-center w-40 h-32 bg-white border-4 border-blue-900 rounded-md px-6 py-4 text-green-600 font-extrabold text-2xl text-center leading-tight"
            >
              ADD
              <br />
              WAYPOINT
            ...
            {/* Distance Meter */}
            <div className="flex flex-col items-center justify-center w-40 h-32 bg-white border-4 border-blue-900 text-black font-bold rounded shadow">
