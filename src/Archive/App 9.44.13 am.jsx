  ...
  return (
    <div className="p-4">
      ...
      <div>
        ...
        {/* Waypoints List */}
        {/* Two-Column Layout: Current Waypoints + Stage Summaries */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
          ...
          <section>
            ...
            <div
              ref={waypointListRef}
              className="max-h-[60vh] overflow-y-auto pr-1 space-y-2 bg-gray-50 rounded-lg p-3"
            >
              {waypoints.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Start a stage and add waypoints to see them here
                  </p>
                </div>
              ) : (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {editingWaypoint === idx ? (
                        ...
                        <p
                          className="font-semibold cursor-pointer hover:bg-yellow-100 px-2 py-1 rounded flex-1"
                    ...
                    {editingWaypoint === idx ? (
                      ...
                      wp.poi && (
                        <p
                          className="text-sm text-gray-600 cursor-pointer hover:bg-yellow-100 px-2 py-1 rounded mt-2 bg-gray-50"
                          onClick={() => startEditingWaypoint(idx)}
                          title="Click to edit"
                        >
                          📝 {wp.poi}
              ...
              <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <div className="text-blue-600">Waypoints</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-blue-800">
                      {waypoints.filter((wp) => wp.voiceCreated).length}
                    </div>
                    <div className="text-blue-600">Voice Created</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-blue-800">
                      {waypoints.length > 0
                        ? waypoints[waypoints.length - 1].distance
                        : 0}{" "}
                      km
                    </div>
                    <div className="text-blue-600">Total Distance</div>
                  </div>
                </div>
              </div>
            )}
          ...
          <section>
            ...
            <div className="max-h-[60vh] overflow-y-auto pr-1 space-y-2 bg-gray-50 rounded-lg p-3">
              {stageSummaries.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-gray-500 text-lg">
                  ...
                  <p className="text-gray-400 text-sm mt-2">
                    Complete a stage to see summary here
                  </p>
                </div>
              ) : (
                stageSummaries.map((summary, idx) => (
                  <div
                    key={idx}
                    className="bg-white shadow-sm rounded border border-gray-200 p-4 hover:shadow-md transition-shadow"
                  >
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <details className="mt-2">
                      ...
                      <div className="mt-1 text-xs text-gray-500 space-y-1">
                        <div>Start: {summary.startCoords}</div>
                        <div>End: {summary.endCoords}</div>
                      </div>
                    </details>

                    {summary.pois && summary.pois.length > 0 && (
              ...
              <div className="mt-3 p-3 bg-green-50 rounded-lg">
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <div className="text-green-600">Stages</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-green-800">
                      {stageSummaries.reduce(
                        (sum, s) => sum + parseInt(s.waypointCount || 0),
                        0
                      )}
                    </div>
                    <div className="text-green-600">Total WPs</div>
                  </div>
                  <div className="text-center">
                    <div className="font-bold text-green-800">
                      {stageSummaries
                        .reduce(
                          (sum, s) => sum + parseFloat(s.totalDistance || 0),
                          0
                        )
                        .toFixed(1)}{" "}
                      km
                    </div>
                    <div className="text-green-600">Total Dist</div>
                  </div>
                </div>
              </div>
            )}
