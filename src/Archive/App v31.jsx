...
export default function App() {
  ...
  const RouteStatsOverlay = () => {
    ...
    return (
      <div className="absolute bottom-4 left-4 bg-white bg-opacity-95 rounded-lg shadow-lg p-4 min-w-48">
      ...
      {showMap && (
        <div className="relative">
          ...
          <div className="relative h-[400px] w-full mb-2">
            ...
            {/* Map Controls - Positioned absolutely within map container */}
            <MapControls />
            <RouteStatsOverlay />
          </div>
        </div>
